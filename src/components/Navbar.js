...
import fullLogo from '../dragon.png';
import {
...
async function connectWebsite() {
    ...
    await window.ethereum.request({ method: 'eth_requestAccounts' })
      .then(() => {
        updateButton();
        getAddress();
        console.log("here"+location.pathname+"fđ");
      ...
      <div className="">
        <nav className="w-screen">
          ...
          <li className='flex items-end ml-5 pb-2'>
            ...
            <div className='inline-block font-bold text-xl ml-2' style={{color: 'black'}}>
              Tài Xỉu Online
            </div>
            </Link>
          </li>
          <li className='w-2/5'>
            <ul className='lg:flex justify-between font-bold mr-10 text-lg'>
              ...
              <li className='border-b-2 hover:pb-0 p-2' style={{color: 'black'}}>
                <Link to="/">Game</Link>
              </li>
              :
              <li className='hover:border-b-2 hover:pb-0 p-2' style={{color: 'black'}}>
                <Link to="/">Game</Link>
              </li>              
              }
              {location.pathname === "/" ? 
